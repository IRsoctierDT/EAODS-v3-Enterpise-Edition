...
| MIG-004 | Volumes 1–7 | Unit-specific canonical locations | Accepted reconstructions (EAODS-HIST-V173-001); no synthesized bodies | Every unit migrated, superseded, or excepted | reconstruction-accepted; ready-to-migrate |
| MIG-014 | Volume 12 | `docs/frameworks/EAODS-v17.3/volume-12-*` | Accepted reconstruction (EAODS-HIST-V173-001) | Front matter, nav, and traceability gates pass | reconstruction-accepted; ready-to-migrate |
